(self.webpackChunklearn_strapi=self.webpackChunklearn_strapi||[]).push([[2544],{4644:(H,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(63838),E=o(40464);const P=(b={},O={})=>{const{id:A,...x}=b,{get:v}=(0,e.kY)();if(!A&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:M,error:W,isError:a,isLoading:B,refetch:p}=(0,E.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await v(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:M,error:W,isError:a,isLoading:B,refetch:p}}},51754:(H,L,o)=>{"use strict";o.d(L,{F:()=>b});var e=o(63838),E=o(61020),P=o(40464);const b=(O={},A={})=>{const{id:x="",...v}=O,{get:M}=(0,e.kY)(),{locale:W}=(0,E.Z)(),a=(0,e.Xe)(W,{sensitivity:"base"}),{data:B,error:p,isError:S,isLoading:F,refetch:g}=(0,P.useQuery)(["roles",x,v],async()=>{const{data:V}=await M(`/admin/roles/${x??""}`,{params:v});return V},A);let y=[];return x&&B?y=[B.data]:Array.isArray(B?.data)&&(y=B.data),{roles:y.sort((V,oe)=>a.compare(V.name,oe.name)),error:p,isError:S,isLoading:F,refetch:g}}},25545:(H,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(27279),E=o(65e3),P=o(42925),b=o(33110),O=o(6854),A=o(35750),x=o(68263),v=o(19915),M=o(86049),W=o(25667),a=o(54095),B=o(60910),p=o(63838),S=o(97367),F=o(84260),g=o(71563),y=o(10124),V=o.n(y),oe=o(61020),ce=o(49402),re=o(51447),C=o(37652),me=o(4644),X=o(36364),G=o(442),_=o(90065),Ce=o(47853);const xe=Ce.Ry().shape({name:Ce.Z_().required(p.I0.required),description:Ce.Z_().required(p.I0.required)}),ae=C.ZP.div`
